...
class ParseResultMixin(object):
    def _generate_authority(self, attributes):
        # I swear I did not align_special_symbols the comparisons below. That's just how they
        # happened to align_special_symbols based on pep8 and attribute lengths.
